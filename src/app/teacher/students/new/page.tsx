...
export default function NewStudentPage() {
  ...
  if (code) {
    ...
    return (
      <div className="max-w-sm mx-auto text-center">
        ...
        <h1 className="mt-3 text-2xl font-extrabold text-violet-900">{name} 학생 초대코드</h1>
        ...
        <p className="mt-3 text-sm text-gray-500">
          코드는 7일간 유효해요. 학생(또는 학부모님)께 전달해 주세요.
        </p>
  ...
  return (
    <div className="max-w-sm mx-auto">
      ...
      <h1 className="mt-4 text-2xl font-extrabold text-violet-900">학생 등록</h1>
      <p className="mt-1 text-sm text-gray-500">
        학생 이름을 입력하면 그 학생 전용 초대코드가 만들어져요.
        <br />
        학생은 코드로 아이디와 비밀번호를 만들어 가입해요.
      </p>
